...
public final class Constants {
  ...
  public static class Swerve {
    ...
    public static final double driveConversionPositionFactor1 = (wheelDiameter * Math.PI);
    public static final double driveConversionPositionFactor2 = (wheelDiameter * Math.PI) / driveGearRatio * 42;
    ...
    public static final class Mod0 {
      ...
      public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID,
          canCoderID, angleOffset, angleMultiplier);
    }
  ...
  public static final class Vision {
    ...
    // public static final double desiredDistanceAmpInches = 37.5 + 6;//37.5 is
    // length of subwoofer from limelight
