...
public class AutoAlignCommand extends Command {
    ...
    private final ProfiledPIDController xController = new ProfiledPIDController(1.5, 0, 0.2,
            new TrapezoidProfile.Constraints(3, 2));
    private final ProfiledPIDController yController = new ProfiledPIDController(1.5, 0, 0.2,
            new TrapezoidProfile.Constraints(3, 2));
    private final ProfiledPIDController thetaController = new ProfiledPIDController(2.0, 0, 0.1,
